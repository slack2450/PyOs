...
def login(): #logs in user
            ...
            if firstRun == "1": #checks to see if this is the first run
                changeLogin() #if so runs changeLogin
            else:
                startMenu.base() #runs start menu
def changeLogin(): #changes login
            ...
            startMenu.base()#launches start menu
def updateLog(): #Defines the updateLog Function
            displayInfo() #Calls the displayInfo function
            print("""\nUpdate Log:
Version 0.0.1:
+ Added Login
+ Added Update Log
...
* Changed "os" class to "pyOs" to allow os module to function""")
            ...
            startMenu.base() #Calls the startMenu
class startMenu: #Start menu class
            def base():#base of start menu
                ...
                print("8. Log Out")
                print("9. Shut down")
                startMenu.userInput("base") #calls the input of start menu with the origin of the initation of the command
            def controlPanel():#control pannel menu
                os.system("cls")
                print("\nAvailable Options:")
                print("1. ChangeLogin")
                print("9. Return")
                startMenu.userInput("controlPanel") #calls the input of start menu with the origin of the initation of the command
            def advanced(): #advanced menu
                ...
                print("9. Return")
                startMenu.userInput("advanced") #calls the input of start menu with the origin of the initation of the command
            def userInput(location): #input for start menu
                ...
                if location == "base":
                    ...
                    if option == "1":
                        ...
                        blueScreenOfDeath("user created test")
                    elif option == "9":
                        startMenu.base()
                    else:
                        print("Option not recognised!")
